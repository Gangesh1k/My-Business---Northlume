// ─────────────────────────────────────────────────────────────────────────────
//  NorthLume AI — Supabase connection
//  Paste your two values between the quotes below, save, and upload this file to GitHub.
//  Where to find them: Supabase → your project → green "Connect" button (or Project Settings → API Keys).
//  Both are PUBLIC by design (they are visible in every visitor's browser); your data is protected
